        ...
        <section className="py-3 py-md-5 my-4">
            <div className="container">
                <div className="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
                    <div className="col-12 col-lg-6 col-xl-5 imgCenter">
                        <img className="img-fluid rounded" loading="lazy" src={AboutUsImg} alt="About 1" width='400px' />
                    </div>
                    <div className="col-12 col-lg-6 col-xl-7">
                        <div className="row justify-content-xl-center">
                            <div className="col-12 col-xl-11">
                                ...
                                <p className="mb-5 text-light">We are a fast-growing company, but we have never lost sight of our core values. We believe in collaboration, innovation, and customer satisfaction. We are always looking for new ways to improve our products and services.</p>
